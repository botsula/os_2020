...
void executer(std::string prog_with_path, std::vector<std::string> tokens, int flag_env, int status) {
...
//            std::cout << line << '\n';
            ...
            executer(prog_with_path, string_arguments, flag_env, status);
        }
